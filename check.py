...
import datetime
import pyttsx3
from about2 import DirectoryOpener
...
class FaceIdentificationSystem:
    ...
    def create_buttons(self):
        translations = {
            "Employee Details": {
                "en_US": "Employee Details",
                "hi_IN": "कर्मचारी विवरण"
            },
            "Face Detector": {
                "en_US": "Face Detector",
        ...
        button_data = [
            ("Employee Details", self.open_student_details),
    ...
    def open_attendance(self):
        ...
        try:
            ...
            print(f"Successfully opened the folder: {folder_path}")
    ...
    def open_Show(self):
        ...
        self.Show_window_app = Show(self.Show_window)

    def open_Edit(self):
        self.Edit_window = tk.Toplevel(self.root)
        self.Edit_window_app = Edit(self.Edit_window)
